...
ggplot(datos_predicciones, aes(x = datos_predicciones$Observado.C_N_mass, y = datos_predicciones$Predicho.C_N_mass.5.comps)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red") +
  labs(title = "Predicciones vs Observaciones (C_N_mass)", x = "Observado C_N_mass", y = "Predicho C_N_mass")

# Grafica de predicciones vs observaciones C_g_m2
ggplot(datos_predicciones, aes(x = datos_predicciones$Observado.C_g_m2, y = datos_predicciones$Predicho.C_g_m2.5.comps)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, color = "red") +
  labs(title = "Predicciones vs Observaciones (C_g_m2)", x = "Observado C_g_m2", y = "Predicho C_g_m2")
